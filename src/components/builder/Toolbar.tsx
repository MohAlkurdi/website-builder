...
export function Toolbar({ className = '' }: ToolbarProps) {
  ...
  const handleReset = () => {
    if (confirm('Are you sure you want to reset the page? This will delete all sections.')) {
      resetPage();
    }
  };
    ...
    <div className={`bg-white border-b border-gray-200 px-4 py-3 ${className}`}>
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2 sm:space-x-4">
          <h1 className="text-lg sm:text-xl font-bold text-gray-900">Website Builder</h1>
        ...
        <div className="flex items-center space-x-1 sm:space-x-2">
          ...
          <div className="flex sm:hidden items-center space-x-1">
            <Button variant="outline" size="sm" onClick={handleImportClick} title="Import">
