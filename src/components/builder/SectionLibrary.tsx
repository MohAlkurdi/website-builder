  ...
  const getIconComponent = (iconName: string) => {
    switch (iconName) {
      ...
      case 'Layers':
        return (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7.875 14.25l1.214 1.942a2 2 0 001.908 1.058h2.006c.776 0 1.497-.4 1.908-1.058l1.214-1.942M2.41 9h4.636a2 2 0 011.872 1.332l.17.518a2 2 0 001.872 1.332H21.59M4 19h16" />
          </svg>
        );
      default:
        return (
